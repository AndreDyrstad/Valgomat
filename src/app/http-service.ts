...
export class HttpService{
  ...
  getData() {
    return this._http.get('https://valgomatserver-turbulent-sable.eu-gb.mybluemix.net/center')
      .map(res => res);
  }
  sendData() {
    ...
    return this._http.post('https://valgomatserver-turbulent-sable.eu-gb.mybluemix.net/center', json).map(res => res);
  }
  sendIssues2(json) {
    return this._http.post('https://valgomatserver-turbulent-sable.eu-gb.mybluemix.net/center', json).map(res => res);
  }
